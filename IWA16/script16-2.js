...
const schalkData = () => {
  ...
  let schalkTime1 = 0;
  for (let i = 0; i < timeFirst.length; i++) {
    schalkTime1 += timeFirst[i]
  }

  let timeSecond = schalk.races[1].time;
  let schalkTime2 = 0;
  for (let i = 0; i < timeSecond.length; i++) {
    schalkTime2 += timeSecond[i]
  }

  let timeThird = schalk.races[2].time;
  let schalkTime3 = 0;
  for (let i = 0; i < timeThird.length; i++) {
    schalkTime3 += timeThird[i]
  }

  let timeFour = schalk.races[3].time;
  let schalkTime4 = 0;
  for (let i = 0; i < timeFour.length; i++) {
    schalkTime4 += timeFour[i]
  }
  ...
  dtS4.textContent = "Total Time (Latest): " + totalSchalkTime;
